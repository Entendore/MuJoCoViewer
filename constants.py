...
/* ── Global ── */
QMainWindow, QWidget {
    background-color: #1a1b26; color: #a9b1d6;
    font-family: 'Segoe UI', 'Arial', sans-serif; font-size: 12px;
}

/* ── Menus ── */
QMenuBar {
    background-color: #1a1b26; border-bottom: 1px solid #24283b; padding: 2px;
}
QMenuBar::item { padding: 4px 10px; }
QMenuBar::item:selected { background-color: #24283b; border-radius: 4px; }
QMenu {
...
QMenu::separator { height: 1px; background: #24283b; margin: 4px 8px; }

/* ── Toolbar ── */
QToolBar {
    background-color: #16161e; border-bottom: 1px solid #24283b;
    spacing: 4px; padding: 3px 6px;
}
QToolButton {
    background-color: #24283b; border: 1px solid #3b4261; border-radius: 4px;
    padding: 5px 10px; color: #a9b1d6; font-weight: 500;
}
QToolButton:hover { background-color: #3d59a1; color: #c0caf5; }
...
QPushButton {
    background-color: #24283b; border: 1px solid #3b4261; border-radius: 4px;
    padding: 5px 14px; color: #a9b1d6; font-weight: 500;
}
QPushButton:hover { background-color: #3d59a1; color: #c0caf5; border-color: #3d59a1; }
...
/* ── Sliders ── */
QSlider::groove:horizontal { height: 6px; background: #24283b; border-radius: 3px; }
...
/* ── Group Boxes ── */
QGroupBox {
    border: 1px solid #24283b; border-radius: 6px;
    margin-top: 12px; padding: 12px 8px 8px 8px; font-weight: bold;
}
QGroupBox::title {
...
/* ── Trees / Tables ── */
QTreeWidget {
    background-color: #1a1b26; border: 1px solid #24283b;
    alternate-background-color: #1f2035; border-radius: 4px;
}
QTreeWidget::item { padding: 3px 0; }
QTreeWidget::item:selected { background-color: #3d59a1; }
QHeaderView::section {
    background-color: #16161e; border: none;
    border-bottom: 1px solid #24283b; padding: 4px;
    font-weight: bold; color: #565f89;
}
QTableWidget {
    background-color: #1a1b26; border: 1px solid #24283b;
    alternate-background-color: #1f2035; border-radius: 4px;
...
QTabWidget::pane { border: 1px solid #24283b; border-radius: 4px; top: -1px; }
QTabBar::tab {
    background-color: #16161e; border: 1px solid #24283b;
    padding: 7px 16px; border-top-left-radius: 6px;
    border-top-right-radius: 6px; margin-right: 2px;
}
QTabBar::tab:selected {
    background-color: #24283b; border-bottom-color: #24283b; color: #7aa2f7;
}

/* ── Labels ── */
QLabel { color: #a9b1d6; background: transparent; }
QLabel[class="value"] { color: #7aa2f7; font-family: 'Consolas', 'Courier New', monospace; }
QLabel[class="dim"] { color: #565f89; font-size: 11px; }
QLabel[class="error"] { color: #f7768e; }
QLabel[class="success"] { color: #9ece6a; }
QLabel[class="warning"] { color: #e0af68; }

/* ── Status Bar ── */
QStatusBar { background-color: #16161e; border-top: 1px solid #24283b; color: #565f89; font-size: 11px; }
QStatusBar QLabel { color: #565f89; }

/* ── Combo / Check / Input ── */
QComboBox {
    background-color: #24283b; border: 1px solid #3b4261; border-radius: 4px;
    padding: 4px 8px; color: #a9b1d6; min-width: 80px;
}
...
QCheckBox::indicator {
    ...
    border-radius: 4px; background-color: #24283b;
}
...
/* ── Text Editors ── */
QPlainTextEdit {
    background-color: #16161e; border: 1px solid #24283b; color: #a9b1d6;
...
QProgressBar {
    ...
    background-color: #16161e; text-align: center; color: #a9b1d6;
}
QProgressBar::chunk { background-color: #3d59a1; border-radius: 3px; }
QSpinBox, QDoubleSpinBox {
    background-color: #24283b; border: 1px solid #3b4261; border-radius: 4px;
    padding: 3px 6px; color: #a9b1d6;
}
QDoubleSpinBox::up-button, QDoubleSpinBox::down-button,
QSpinBox::up-button, QSpinBox::down-button {
    background-color: #3b4261; border: none; width: 16px;
}
QLineEdit {
    background-color: #16161e; border: 1px solid #3b4261; border-radius: 4px;
    padding: 4px 8px; color: #a9b1d6;
}
QLineEdit[class="search"] {
    background-color: #1a1b26; border: 1px solid #3b4261; border-radius: 12px;
    padding: 4px 10px 4px 24px; color: #a9b1d6; font-size: 11px;
}
...
QListWidget {
    background-color: #1a1b26; border: 1px solid #24283b; border-radius: 4px;
    color: #a9b1d6;
}
QListWidget::item { padding: 4px 8px; }
QListWidget::item:selected { background-color: #3d59a1; }
"""